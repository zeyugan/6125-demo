...
const WithdrawalPage = () => {
  ...
  const handleWithdrawal = () => {
    ...
    if (Number(withdrawAmount) > usdBalance) {
    ...
    setTimeout(() => {
      const newBalance = usdBalance - Number(withdrawAmount);
  ...
  return (
    <div className="h-screen bg-white text-black p-6 flex items-start justify-center">
        ...
        <div className="bg-gray-100 rounded-lg p-6 shadow-lg w-[400px]">
          ...
          <div className="bg-white p-3 rounded-lg flex justify-between items-center shadow text-sm cursor-pointer" onClick={openModal}>
            <div>
              ...
              <p className="text-gray-400">1 to 5 business days</p>
            </div>
      ...
      >
        ...
        <div className="mb-4">
          <label className="block text-lg font-semibold mb-2">Withdrawal Method</label>
          <select 
        ...
        <div className="flex justify-end space-x-2">
          ...
          <button className="bg-blue-500 text-white py-2 px-4 rounded-lg" onClick={handleWithdrawal}>
            Confirm
          </button>
        </div>
      </Modal>
